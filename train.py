...
def train(model, criterion, dataset,
    ...
    if not args.only_test:
        ...
        #DRO-adversarial training methods not
        ...
        for epoch in range(epoch_offset, epoch_offset+args.n_epochs):
            ...
            # WAT parameters update
            if args.train_type=='WAT':
                wat_valid_nat_cost, wat_valid_bndy_cost, val_rob_acc, val_rob_class_wise_acc = validate(model,dataset['val_loader'],wat_valid_nat_cost,wat_valid_bndy_cost,args,epoch,
                                                                                                        device=args.device)
