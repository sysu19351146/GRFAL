...
class SingleModelAlgorithm(GroupAlgorithm):
    ...
    def get_model_outputpgd(self, x, y_true):
        try:
            need_y = self.model.needs_y
        except:
            need_y = self.model.module.needs_y
    ...
    def evaluate(self, batch):
        ...
        results = self.process_batch_pgd(batch)
    ...
    def _update(self, results,batch, should_step=False):
        """
        ...
        """
        # compute objective
        objective = self.objective(results,batch)
