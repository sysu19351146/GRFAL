...
parser.add_argument('--resume', type=parse_bool, const=True, nargs='?', default=True, help='Whether to resume from the most recent saved model in the current log_dir.')
